...
def bfs(i, j, moves, isBreak):
    ...
    # [0, 0, ..., 0]-[벽을 idx 번 부수고 방문한 경우, 벽을 부수기 전 방문한 경우]
    visited[i][j][isBreak] = 1
    ...
    while q:
        ...
        for k in range(4):
            ...
            if board[ni][nj] == '1' and isBreak > 0:  # 벽이지만 부술 수 있음
                visited[ni][nj][isBreak - 1] = 1
                q.append((ni, nj, now_move + 1, isBreak - 1))  # 벽 부수고 이동
